    ...
    return (
      <div>
        <button
          ...
          className="bg-black text-white font-bold uppercase text-sm px-5 py-2 rounded-2xl shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
          type="button"
        >
          ログイン
        </button>
        ...
        >
          ...
          <div className="flex flex-col justify-end h-full">
            ...
            <div className="w-full mb-4">
              ...
              >
                <img src="/github_icon.svg" alt="GitHub Icon" className="mr-2" style={{ width: '30px', height: '30px' }} />
                GitHubでログイン
              </button>
